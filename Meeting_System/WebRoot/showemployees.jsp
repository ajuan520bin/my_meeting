			...
			<div class="menu">
				<ul id="menu">
					...
					<li id="menu-academico"><a href="#"><i
							class="fa fa-file-text-o"></i> <span>人员管理</span> <span
							class="fa fa-angle-right" style="float: right"></span></a>
						<ul id="menu-academico-sub">
							<li id="menu-academico-avaliacoes"><a
								href="AddDepartmentServlet">部门管理</a></li>
							<li id="menu-academico-boletim"><a
								href="ApprovalEmployeeServlet?code=approve">注册审批</a></li>
							<li id="menu-academico-boletim"><a href="findemployee.jsp">搜索员工</a></li>
					...
					<li id="menu-academico"><a href="#"><i
						...
						<ul id="menu-academico-sub">
							<li id="menu-academico-avaliacoes"><a
								href="addmeetingroom.jsp">添加会议室</a></li>
							<li id="menu-academico-boletim"><a href="MeetingRoomServlet">查看会议室</a></li>
							<li id="menu-academico-boletim"><a href="findroom.jsp">预定会议室</a></li>
						</ul></li>
					<li><a href="#"><i class="lnr lnr-envelope"></i> <span>实用工具</span><span
							class="fa fa-angle-right" style="float: right"></span></a>
						<ul>
							<li><a href="calinput.jsp"><i class="fa fa-inbox"></i>
									个人所得税</a></li>
							<li><a href="weather.jsp"><i
					...
					<li id="menu-academico"><a href="#"><i class="lnr lnr-layers"></i> <span>投票签到</span> <span class="fa fa-angle-right" style="float: right"></span></a>
						<ul id="menu-academico-sub">
							...
							<li id="menu-academico-boletim"><a href="addvote.jsp">发起投票</a></li>
							<li id="menu-academico-boletim"><a href="signin.jsp">进行签到</a></li>
					...
					<li id="menu-comunicacao"><a href="#"><i
						...
						<ul id="menu-comunicacao-sub">
							...
							<li id="menu-arquivos"><a href="aboutus.jsp">aboutus</a></li>
						</ul></li>
				</ul>
			</div>
		</div>
