	...
	<div class="page-container">
						...
						<table border="1" width="700px" height="100px" align="center">
							...
							<c:forEach items="${requestScope.list}" var="emp">
								<tr>
									...
									<td>${emp.roomid}</td>
									<td>${emp.reservationistid}</td>
									<td>${emp.numberofparticipants}</td>
									<td>${emp.starttime}</td>
									<td>${emp.endtime}</td>
									<td>${emp.reservationtime}</td>
									<td>${emp.canceledtime}</td>
	         ...
	         <table class="table">
							...
							%>
								<tr class=<%=tt %>>
									...
									<td>${emp.roomname}</td>
									<td>${emp.status}</td>
									<td><a href="ShowRoomDetail?roomid=${emp.roomid}">查看详情</a></td>
								</tr>
							</c:forEach>
						</table>
		...
		<div class="sidebar-menu">
			...
			<div class="down">
				...
				<ul>
					<li><a class="tooltips" href="userindex.jsp"><span>个人设置</span><i
							class="lnr lnr-user"></i></a></li>
					<li><a class="tooltips" href="userindex.jsp"><span>设置</span><i
							class="lnr lnr-cog"></i></a></li>
					<li><a class="tooltips" href="userindex.jsp"><span>退出</span><i
