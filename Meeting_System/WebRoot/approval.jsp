							...
							<table class="table">
								...
								<c:forEach items="${requestScope.list}" var="emp">
									...
									<tr class=<%=tt%>>
										...
										<td>${emp.email}</td>
										<td><a
											href="ApprovalServlet?employeeid=${emp.employeeid}&approval=1">通过</a>&nbsp;&nbsp;&nbsp;<a
											href="ApprovalServlet?employeeid=${emp.employeeid}&approval=0">不通过</a></td>
									</tr>
								</c:forEach>
							</table>
						</div>
